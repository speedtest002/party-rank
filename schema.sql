...
CREATE TABLE party_ranks (
  ...
  created_by_discord_id TEXT REFERENCES "user"(discord_id) ON DELETE SET NULL,
...
-- Index for render progress queries
CREATE INDEX idx_renders_pr_id ON renders(pr_id);
